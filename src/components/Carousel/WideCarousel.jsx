...
import { wideCarousel_img } from '@/assets/constants';

const WideCarousel = () => {
  const images = wideCarousel_img;
  console.log(images);
    ...
    <div id="default-carousel" className="relative w-full">
      ...
      <div className="relative h-56 overflow-hidden md:h-96">
        {images.map(({ id, image }, index) => (
          <div key={id} className={`duration-700 ease-in-out ${index === currentIndex ? 'block' : 'hidden'}`}>
            <img
              src={image}
